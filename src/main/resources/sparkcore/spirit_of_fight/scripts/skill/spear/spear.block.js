Skill.createBy("spirit_of_fight:spear.block", "spirit_of_fight:block", builder => {
    builder.addEntityAnimatableCondition()
    builder.acceptConfig(config => {
        config.set("anim_path", "spirit_of_fight:spirit_of_fight/animations/player/fight_skill/spear/spear.skills.common/spear.block")
