Skill.create("spirit_of_fight:spear.switch_attack", builder => {
    ...
    builder.accept(skill => {
        ...
        const anim = animatable.createAnimation("minecraft:player", "spear.switch_attack.backward")
        ...
        const attackKF = anim.registerKeyframeRange("attack", 0.25, 0.6)
        attackKF.onEnter(() => {
