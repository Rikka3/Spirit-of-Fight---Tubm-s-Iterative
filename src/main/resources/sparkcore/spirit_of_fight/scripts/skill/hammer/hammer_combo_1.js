Skill.create("spirit_of_fight:hammer_combo_1", builder => {
    builder.accept(skill => {
        ...
        const anim = animatable.createAnimation('minecraft:player', 'hammer:combo_1')
        ...
        skill.onActive(() => {
            ...
            if (animTime >= 0.35 && animTime <= 0.75) {
