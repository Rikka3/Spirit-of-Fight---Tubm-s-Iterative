Skill.create("spirit_of_fight:hammer.special.combo_2", builder => {
    ...
    builder.accept(skill => {
        ...
        const attackKF = anim.registerKeyframeRange("attack", 0.6, 0.75)
        attackKF.onEnter(() => {
            attackBody.setCollideWithGroups(1)
            entity.move([0.0, entity.getDeltaMovement().y, 0.3], false)
            entity.setCameraLock(true)
            level.playSound(entity.getOnPos().above(), "spirit_of_fight:hard_wield_1", "players", 1.0, 1)
        })
        attackKF.onInside(() => {
