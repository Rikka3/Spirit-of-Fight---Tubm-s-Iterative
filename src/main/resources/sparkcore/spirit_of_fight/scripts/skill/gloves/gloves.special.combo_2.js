Skill.create("spirit_of_fight:gloves.special.combo_2", builder => {
    ...
    builder.accept(skill => {
        ...
        attackBody.onAttackCollide('attack', {
            ...
            doAttack: (attacker, target, o1, o2, manifoldId, attackSystem) => {
                entity.sofCommonAttack(target, "heavy_swipe", 25, 25)
            },
        ...
        anim.registerKeyframeRanges("attack", [[0.2, 0.35]], (attackKF, index) => {
            attackKF.onEnter(() => {
