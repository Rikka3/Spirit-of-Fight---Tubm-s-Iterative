Skill.create("spirit_of_fight:gloves_skill_0", builder => {
    builder.accept(skill => {
        ...
        const anim = animatable.createAnimation('minecraft:player', 'baimei:skill_keeping')
        ...
        skill.onTargetActualHurtPost(event => {
            level.playSound(entity.getOnPos().above(), "spirit_of_fight:soft_under_attack_2", "players")
            SOFParticlePresets.summonQuadraticParticle(event.getSource(), 15, 'minecraft:crit')
            SOFParticlePresets.summonQuadraticParticle(event.getSource(), 15, 'minecraft:white_smoke')
        })
