Skill.create("spirit_of_fight:sword.default.shield.combo_2", builder => {
    ...
    builder.accept(skill => {
        ...
        const attackBody = PhysicsHelper.createCollisionBoxBoundToBone(animatable, 'leftItem', [0.5, 1.0, 2.0], [-0.25, 0.25, 0.0])
        ...
        skill.onTargetActualHurtPost(event => {
            ...
            target.addEffect("minecraft:slowness", 100, 2, false, false, false)
        ...
        const attackKF = anim.registerKeyframeRange("attack", 0.2, 0.35)
        attackKF.onEnter(() => {
