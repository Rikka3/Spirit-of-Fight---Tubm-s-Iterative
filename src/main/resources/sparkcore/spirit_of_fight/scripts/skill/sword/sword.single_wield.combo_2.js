Skill.create("spirit_of_fight:sword.single_wield.combo_2", builder => {
    builder.accept(skill => {
        ...
        const anim = animatable.createAnimation('spirit_of_fight:spirit_of_fight/animations/player/fight_skill/fightskill_sword','sword.single_wield.combo_2')
