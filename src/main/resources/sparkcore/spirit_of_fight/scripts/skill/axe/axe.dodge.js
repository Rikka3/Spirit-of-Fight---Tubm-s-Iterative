Skill.createBy("spirit_of_fight:axe.dodge", "spirit_of_fight:dodge", builder => {
    ...
    builder.accept(skill => {
        ...
        const anim = SOFHelper.createAnimByDirection(animatable, "minecraft:player", `axe.${entity.getWieldStyleName()}.dodge`, "forward")
