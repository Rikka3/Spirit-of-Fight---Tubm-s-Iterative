Skill.create("spirit_of_fight:axe.default.combo_2", builder => {
    ...
    builder.acceptConfig(config => {
        ...
        config.set("target_knockback_strength", 0.35)
    ...
    builder.accept(skill => {
        ...
        attackBody.onAttackCollide('attack', {
            ...
            doAttack: (attacker, target, o1, o2, manifoldId, attackSystem) => {
                entity.sofCommonAttack(target, "heavy_swipe", 30, 30)
            },
        ...
        const attackKF = anim.registerKeyframeRange("attack", 0.2, 0.45)
        attackKF.onEnter(() => {
