Skill.createBy("spirit_of_fight:axe.block", "spirit_of_fight:block", builder => {
    builder.addEntityAnimatableCondition()
    builder.acceptConfig(config => {
        config.set("anim_path", "spirit_of_fight:spirit_of_fight/animations/player/fight_skill/axe/axe.skills.common/axe.block")
