Skill.create("spirit_of_fight:mace_jump_attack", builder => {
    ...
    builder.acceptConfig(config => {
        ...
        config.set("target_knockback_strength", 0.6)
    ...
    builder.accept(skill => {
        ...
        skill.onTargetActualHurtPost(event => {
            level.playSound(entity.getOnPos().above(), "spirit_of_fight:heavy_under_attack_1", "players")
