Skill.create("spirit_of_fight:mace.default.combo_3", builder => {
    ...
    builder.accept(skill => {
        ...
        const anim = animatable.createAnimation("minecraft:player", "mace.combo_2")
        anim.setShouldTurnBody(true)
        const attackBody = PhysicsHelper.createCollisionBoxBoundToBone(animatable, 'rightItem', [1.75, 1.75, 1.75], [0.0, 0.0, -0.75])
        ...
        // Based on mace.combo_2 length 1.3333
        const attackKF = anim.registerKeyframeRange("attack", 0.25, 0.55)
        attackKF.onEnter(() => {
