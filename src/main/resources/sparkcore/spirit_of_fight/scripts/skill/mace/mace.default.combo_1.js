Skill.create("spirit_of_fight:mace.default.combo_1", builder => {
    ...
    builder.accept(skill => {
        ...
        const anim = animatable.createAnimation("minecraft:player", "mace.combo_0")
        ...
        skill.onTargetActualHurtPost(event => {
            level.playSound(entity.getOnPos().above(), "spirit_of_fight:heavy_under_attack_1", "players", 1, 1.1)
