Skill.create("spirit_of_fight:axe_combo_0", builder => {
    builder.accept(skill => {
        ...
        const anim = animatable.createAnimation('spirit_of_fight:spirit_of_fight/animations/player/fight_skill/fightskill_axe','axe_combo_0')
