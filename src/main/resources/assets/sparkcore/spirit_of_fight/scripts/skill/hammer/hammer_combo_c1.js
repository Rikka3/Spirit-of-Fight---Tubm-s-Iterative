Skill.create("spirit_of_fight:hammer_combo_c1", builder => {
    builder.accept(skill => {
        ...
        const anim = animatable.createAnimation('minecraft:player', 'hammer:combo_c1')
