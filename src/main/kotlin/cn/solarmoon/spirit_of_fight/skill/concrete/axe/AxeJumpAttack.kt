...
class AxeJumpAttack(
    ...
    val comboAnim = createAnimInstance("axe:attack_jump") {
        shouldTurnBody = true
        onEnable {
    ...
    init {
        addComponent(StuckEffectComponent(5, 0.05) { comboAnim.time in 0.15..0.45 })
        addComponent(AnimBoxAttackComponent(entity, comboAnim, SOFHitTypes.HEAVY_CHOP.get(), { 0.85 }) { time in 0.15..0.45 })
    }
