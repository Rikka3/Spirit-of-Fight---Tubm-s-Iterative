...
class HammerCombo2(
    ...
    init {
        addComponent(AnimBoxAttackComponent(entity, comboAnim, SOFHitTypes.KNOCKDOWN_CHOP.get(), { 1.5 }) { time in 0.4..0.75 })
        addComponent(AnimMoveSetComponent(entity, comboAnim) { if (time in 0.0..0.65) entity.getForwardMoveVector(1/7f) else null })
    }
