    ...
    val MAIN = SpiritOfFight.REGISTER.creativeTab()
        ...
        .bound(CreativeModeTab.builder()
            ...
            .displayItems { params, output ->
                ...
                output.accept(ItemStack(SOFItems.WOODEN_GREATSWORD.get()))
                output.accept(ItemStack(SOFItems.STONE_GREATSWORD.get()))
                output.accept(ItemStack(SOFItems.IRON_GREATSWORD.get()))
                output.accept(ItemStack(SOFItems.GOLDEN_GREATSWORD.get()))
                output.accept(ItemStack(SOFItems.DIAMOND_GREATSWORD.get()))
                output.accept(ItemStack(SOFItems.NETHERITE_GREATSWORD.get()))
            }
        )
        .build()
